...
SettingsCursorTileData::
    db OPTION_CURSOR_LEVEL_ROW, OPTION_CURSOR_LEFT_COL, OPTION_CURSOR_INACTIVE_LEFT_TILE
    db OPTION_CURSOR_LEVEL_ROW, OPTION_CURSOR_RIGHT_COL, OPTION_CURSOR_INACTIVE_RIGHT_TILE
    db OPTION_CURSOR_SPEED_ROW, OPTION_CURSOR_LEFT_COL, OPTION_CURSOR_INACTIVE_LEFT_TILE
    db OPTION_CURSOR_SPEED_ROW, OPTION_CURSOR_RIGHT_COL, OPTION_CURSOR_INACTIVE_RIGHT_TILE
    db OPTION_CURSOR_BGM_ROW, OPTION_CURSOR_LEFT_COL, OPTION_CURSOR_INACTIVE_LEFT_TILE
    db OPTION_CURSOR_BGM_ROW, OPTION_CURSOR_BGM_RIGHT_COL, OPTION_CURSOR_INACTIVE_RIGHT_TILE
    db TILE_TRIPLET_LIST_END
...
SettingsCursorTileData0::
    db OPTION_CURSOR_LEVEL_ROW, OPTION_CURSOR_LEFT_COL, OPTION_CURSOR_ACTIVE_LEFT_TILE
    db OPTION_CURSOR_LEVEL_ROW, OPTION_CURSOR_RIGHT_COL, OPTION_CURSOR_ACTIVE_RIGHT_TILE
    db TILE_TRIPLET_LIST_END
SettingsCursorTileData1::
    db OPTION_CURSOR_SPEED_ROW, OPTION_CURSOR_LEFT_COL, OPTION_CURSOR_ACTIVE_LEFT_TILE
    db OPTION_CURSOR_SPEED_ROW, OPTION_CURSOR_RIGHT_COL, OPTION_CURSOR_ACTIVE_RIGHT_TILE
    db TILE_TRIPLET_LIST_END
SettingsCursorTileData2::
    db OPTION_CURSOR_BGM_ROW, OPTION_CURSOR_LEFT_COL, OPTION_CURSOR_ACTIVE_LEFT_TILE
    db OPTION_CURSOR_BGM_ROW, OPTION_CURSOR_BGM_RIGHT_COL, OPTION_CURSOR_ACTIVE_RIGHT_TILE
    db TILE_TRIPLET_LIST_END
    ret
