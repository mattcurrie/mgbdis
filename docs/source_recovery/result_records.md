...
| `$C74B-$C755` | `CURRENT_RESULT_RECORD` | `ClearField` stages the current score digits, displayed level digits, and A/B-specific detail digits here before comparing and inserting the record. |
