...
- Revisit `$C69D`, `$C6AE`, `$C6BF`, and `$C6C0` only after finding stronger
  producer/consumer evidence. They are now documented as unresolved
  landing/scan bytes in `fall_timing.md`.
