...
- `DrawOptionMarkers` clears eight marker positions from `OptionMarkerPositions`, then writes tile `$9A` at the currently selected game type, speed, and BGM positions.
