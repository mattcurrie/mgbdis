...
YOSHI_GRAPHICS_RANGES = (
    ...
    TileRange("bank2_preplay_menu_overlay_tiles", 2, 0x5800, 0x0800, "PreplayMenuOverlayTiles -> pre-play $8800 overlay"),
    TileRange("bank2_title_tileset", 2, 0x6000, 0x1000, "TitleTileSet -> title $8800 load"),
    TileRange("bank2_two_player_nonmaster_tiles", 2, 0x6F70, 0x0260, "TwoPlayerNonMasterTiles -> $81C0, skipped for master"),
    TileRange("bank2_two_player_shared_tiles", 2, 0x71D0, 0x0200, "TwoPlayerSharedTiles -> $9500, all 2P"),
    TileRange("bank2_unused_tail_tile_data", 2, 0x73D0, 0x0C30, "Bank2UnusedTailTileData, no confirmed load"),
    TileRange("bank3_full_graphics_data", 3, 0x4000, 0x4000, "Bank3GraphicsData full graphics block"),
    TileRange("bank3_matching_tiles_to9000", 3, 0x4000, 0x0800, "Bank3MatchingTilesTo9000 -> $9000"),
    TileRange("bank3_matching_tiles_to8800", 3, 0x4800, 0x0800, "Bank3MatchingTilesTo8800 -> $8800"),
    TileRange("bank3_matching_tiles_to8000", 3, 0x4E40, 0x0800, "Bank3MatchingTilesTo8000 -> $8000"),
    TileRange("bank3_result_record_tiles_to9000", 3, 0x5400, 0x0800, "Bank3ResultRecordTilesTo9000 -> $9000"),
    TileRange("bank3_result_record_tiles_to8800", 3, 0x5C00, 0x0800, "Bank3ResultRecordTilesTo8800 -> $8800"),
    TileRange("bank3_link_result_5dd0", 3, 0x5DD0, 0x0800, "Link-result names/text/number fragments -> $9000"),
    TileRange("bank3_link_result_65d0", 3, 0x65D0, 0x0800, "Link-result character and border fragments -> $8800"),
    TileRange("bank3_link_result_overlay_6ab0", 3, 0x6AB0, 0x0390, "Conditional terminal link-result character overlay -> $9470"),
    TileRange("bank3_link_result_overlay_6e40", 3, 0x6E40, 0x0740, "Conditional terminal link-result character overlay -> $8800"),
    TileRange(
        "rom0_round_complete_summary_graphics",
        0,
        0x3839,
        0x0500,
        "RoundCompleteSummaryGraphicTileData -> queued $8820",
    ),
    TileRange(
        "rom0_round_complete_summary_text",
        0,
        0x3D39,
        0x0110,
        "RoundCompleteSummaryTextTileData glyph records -> queued $9140",
    ),
)
